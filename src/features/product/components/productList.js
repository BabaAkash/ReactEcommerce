...
export  default function ProductList() {
 ...
 const filters = [
  ...
  // option mien joh value hai joh apney select ki hai
  // section ==> category h ya brand
  ...
  const  handleFilter =(e, section, option)=>{
    ...
    /// TODO: on server it will support miltiple categories
    if(e.target.checked){
      ...
      <MobileFilter filters={filters} mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} handleFilter={handleFilter} ></MobileFilter>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
           ...
           <DestopFilter filters={filters} handleFilter={handleFilter}></DestopFilter>

              {/* Product grid */}
              <div className="lg:col-span-3"> {/* // this is product page */}
                <ProductGrid  products={products}></ProductGrid>
              </div>
            </div>
          </section>
         
             <Pagination page ={page} totalItems={totalItems} handlePage={handlePage} setPage={setPage}></Pagination>
...
function Pagination({handlePage,totalItems, page, setPage}){
          ...
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
           ...
           {Array.from({length:totalPages}).map((el, index)=>(
            <div
             ...
             ${index+1===page? 'bg-indigo-600 text-white ':'text-gray-400'}  px-4 py-2 text-sm font-semibold 
